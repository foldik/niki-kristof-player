...
public class LineTest {
	...
	public void testColumn() {
		...
		//THEN
		assertEquals(new Element(0, 1, "X"), elements.get(0));
		assertEquals(new Element(0, 2, "X"), elements.get(1));
		assertEquals(new Element(0, 3, "X"), elements.get(2));
		assertEquals(new Element(0, 4, "X"), elements.get(3));
	}
	...
	public void testRow() {
		...
		//THEN
		assertEquals(new Element(1, 0, "X"), elements.get(0));
		assertEquals(new Element(2, 0, "X"), elements.get(1));
		assertEquals(new Element(3, 0, "X"), elements.get(2));
		assertEquals(new Element(4, 0, "X"), elements.get(3));
	}
	...
	public void testRightDiagonal() {
		...
		//THEN
		assertEquals(new Element(1, 1, "X"), elements.get(0));
		assertEquals(new Element(0, 2, "X"), elements.get(1));
		assertEquals(new Element(-1, 3, "X"), elements.get(2));
		assertEquals(new Element(-2, 4, "X"), elements.get(3));
	}
